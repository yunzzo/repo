...
import { Modal, View, StyleSheet, Button, Text, Pressable, Dimensions, TouchableOpacity, FlatList} from 'react-native';
...
const NicknameModal = (props) => {
    ...
    const renderItem = ({item}) => {
        return(
            <MainButton onPress={setSelectedNickname}>{item}</MainButton>
        )
    };
